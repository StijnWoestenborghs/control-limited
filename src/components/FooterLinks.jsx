            ...
            <div className="flex flex-col space-y-3 text-sm">
                <a href="https://github.com/StijnWoestenborghs" target="_blank" rel="noopener noreferrer" 
                   className="text-secondary hover-primary flex items-center space-x-2">
                    ...
                    <span>GitHub: StijnWoestenborghs</span>
                </a>
                <a href="https://www.linkedin.com/in/stijnwoestenborghs/" target="_blank" rel="noopener noreferrer"
                   className="text-secondary hover-primary flex items-center space-x-2">
                    ...
                    <span>LinkedIn: stijnwoestenborghs</span>
                </a>
                <a href="mailto:stijn.woestenborghs@live.be"
                   className="text-secondary hover-primary flex items-center space-x-2">
                    <EnvelopeIcon className="h-4 w-4" />
                    <span>Email: stijn.woestenborghs@live.be</span>
                </a>
                <a href="tel:+32474062485"
                   className="text-secondary hover-primary flex items-center space-x-2">
                    <PhoneIcon className="h-4 w-4" />
                    <span>Call: +32 474 06 24 85</span>
                </a>
            </div>
        </div>
    );
